...
- `RAVDESS` dataset card:
  - source: <https://audeering.github.io/datasets/datasets/ravdess.html>
  - license: `CC-BY-NC-SA-4.0`
  - usage: `research`
- `EmoV-DB` license:
  - source: <https://github.com/numediart/EmoV-DB/blob/master/LICENSE.md>
  - status: non-commercial only unless separately licensed
- `CREMA-D` dataset card:
  - source: <https://audeering.github.io/datasets/datasets/crema-d.html>
  - license: `ODbL v1.0`
  - usage: `commercial`
- `EMO-DB` dataset card:
  - source: <https://audeering.github.io/datasets/datasets/emodb.html>
  - license: `CC0-1.0`
  - usage: `unrestricted`

These alternatives matter because the current accepted path is performance-blocked, but future commercialization work also benefits from a cleaner corpus base than `RAVDESS` plus non-commercial alternates.
