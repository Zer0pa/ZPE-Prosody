...
- Command: `rm -rf '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/UTMOSv2' && git clone --depth 1 https://github.com/sarulab-speech/UTMOSv2 '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/UTMOSv2'`
  - Return code: 0
- Command: `if [ -f '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/UTMOSv2/requirements.txt' ]; then '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install -r '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/UTMOSv2/requirements.txt'; else '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install -e '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/UTMOSv2'; fi`
  - Return code: 0
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "import utmosv2; print('utmosv2_ok')"`
  - Return code: 1
...
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install speechmos onnxruntime`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "from speechmos import dnsmos; print('speechmos_dnsmos_ok')"`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python`
...
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install datasets soundfile`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "import json, wave, struct, pathlib; from datasets import load_dataset; out=pathlib.Path('/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/ravdess'); out.mkdir(parents=True, exist_ok=True); ds=load_dataset('narad/ravdess', split='train[:120]'); meta=[]; 
...
- Command: `curl -s https://zenodo.org/api/records/1188976 | rg -n "license|rights|access_right"`
  - Return code: 0
- Command: `test -f '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/ravdess/manifest.json'`
  - Return code: 0
...
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install --index-url https://download.pytorch.org/whl/cpu torch torchaudio`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install torchcrepe`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "import torch, torchcrepe; print(torch.__version__)"`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python`
...
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install praat-parselmouth`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "import parselmouth; print(parselmouth.__version__)"`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python`
...
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install TTS`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install 'transformers==4.41.2'`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
...
- Command: `rm -rf '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice' && git clone --depth 1 https://github.com/FunAudioLLM/CosyVoice '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice'`
  - Return code: 0
- Command: `git -C '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice' submodule update --init --recursive`
  - Return code: 0
- Command: `test -f '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice/LICENSE' && rg -n "Apache" '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice/LICENSE'`
  - Return code: 0
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install -r '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice/requirements.txt'`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `PYTHONPATH='/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice:$PYTHONPATH' '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "from cosyvoice.cli.cosyvoice import CosyVoice; print('cosyvoice_ok')"`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python`
...
- Command: `docker --version`
  - Return code: 0
- Command: `docker build -t cosyvoice_runtime_probe '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/CosyVoice/runtime/python'`
  - Return code: 1
...
- Command: `curl -L -s https://raw.githubusercontent.com/huggingface/parler-tts/main/LICENSE | rg -n "apache" -i`
  - Return code: 0
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install parler-tts accelerate`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' - <<'PY'
...
- Command: `curl -L -s https://raw.githubusercontent.com/rhasspy/piper/master/LICENSE.md | rg -n "mit" -i`
  - Return code: 0
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip' install piper-tts`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/pip`
...
- Command: `curl -L -o '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/piper_models/en_US-lessac-medium.onnx.json' https://huggingface.co/rhasspy/piper-voices/resolve/main/en/en_US/lessac/medium/en_US-lessac-medium.onnx.json`
  - Return code: 0
- Command: `printf 'Prosody transfer validation sentence.' | '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/piper' --model '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/piper_models/en_US-lessac-medium.onnx' --config '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/piper_models/en_US-lessac-medium.onnx.json' --output_file 'artifacts/2026-02-20_zpe_prosody_wave1/piper_probe.wav'`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/piper`
...
- Command: `curl -L -s https://raw.githubusercontent.com/numediart/EmoV-DB/master/LICENSE.md | head -n 30`
  - Return code: 0
- Command: `find '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db' -type f \( -name '*.wav' -o -name '*.flac' \) | head -n 5`
  - Return code: 0
- Command: `if [ "$(find '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db' -type f -name '*.wav' | wc -l | tr -d ' ')" -lt 16 ]; then mkdir -p '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db' && curl -L -o '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db/emovdb.zip' https://www.openslr.org/resources/115/emovdb.zip; else echo 'skip_download_has_audio'; fi`
  - Return code: 0
- Command: `if [ -f '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db/emovdb.zip' ]; then unzip -o -q '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db/emovdb.zip' -d '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db'; else echo 'skip_unzip_no_zip'; fi`
  - Return code: 9
  - Failure signature: `[/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db/emovdb.zip]`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "import json, pathlib; root=pathlib.Path(r'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db'); root.mkdir(parents=True, exist_ok=True); files=sorted(list(root.rglob('*.wav')) + list(root.rglob('*.flac'))); items=[{'path':str(p),'label':p.parent.name.lower(),'sr':0} for p in files[:240]]; pathlib.Path(r'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db/manifest.json').write_text(json.dumps({'items':items}, indent=2)); print(len(items))"`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python`
- Command: `'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python' -c "import json, pathlib, sys; p=pathlib.Path(r'/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/emov_db/manifest.json'); items=json.loads(p.read_text()).get('items', []) if p.exists() else []; print(len(items)); sys.exit(0 if len(items) >= 16 else 3)"`
  - Return code: 127
  - Failure signature: `zsh:1: no such file or directory: /Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/.runtime/maxwave/venv/bin/python`
...
- Command: `rm -rf '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/EmoVoice' && git clone --depth 1 https://github.com/yanghaha0908/EmoVoice '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/EmoVoice'`
  - Return code: 0
- Command: `find '/Users/prinivenpillay/ZPE Multimodality/ZPE Prosody/data/external/EmoVoice' -type f \( -name '*.wav' -o -name '*.flac' \) | head -n 5`
  - Return code: 0
