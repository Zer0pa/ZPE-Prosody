...
Deterministic prosody-feature codec. F0, energy, duration, and voiced-mask bundles round-trip with bounded-lossy quantization within CI thresholds. Install from PyPI: `pip install zpe-prosody`
