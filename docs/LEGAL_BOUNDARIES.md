...
Repo scope (Prosody truth only) for the current repo boundary:
<table width="100%" border="1" bordercolor="#b8c0ca" cellpadding="0" cellspacing="0">
  ...
  <tbody>
    <tr>
      <td>Repo contents</td>
      <td>Code, tests, runbooks, and accepted proof artifacts</td>
    </tr>
    <tr>
      <td>External corpora</td>
      <td>Not shipped in this repo</td>
    </tr>
    <tr>
      <td>Commercial-safe closure</td>
      <td>Not claimed for the transfer stack</td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="1" bordercolor="#b8c0ca" cellpadding="0" cellspacing="0">
  ...
  <tbody>
    <tr>
      <td><code>PRO-C005</code></td>
      <td><code>PAUSED_EXTERNAL</code> because a commercial-safe transfer substitute was not proven in-lane</td>
    </tr>
    <tr>
      <td><code>PRO-C006</code></td>
      <td><code>FAIL</code> on accepted evidence</td>
    </tr>
  </tbody>
</table>
